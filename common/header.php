...
{
$url_RED=$_SERVER['PHP_SELF'];
$url_RED=base64_encode($url_RED);
?>
<script>window.location='login.php?token=<?php echo $url_RED; ?>'</script>
<?php
}
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Welcome <?php echo $rowData->signatory_name?></a>
            </div>
