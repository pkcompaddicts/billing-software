...
{
	$up=DB::getInstance()->insert('expense_category',$tmp= null,$path= null,array('title' => $subcat,'added_by' => $upby, 'added_on' => $date,'status' => 1));
	$_SESSION['msg']="Category Added Successfully";
  ?>
<script>window.location='expense-category.php'</script>
<?php
}
else
{
...
$del=DB::getInstance()->delete('expense_category',array('id','=',$id));
...
case "activate":
$id=base64_decode($_REQUEST['id']);
$up=DB::getInstance()->update('expense_category','id',$id,$tmpimg= null,$path= null,array('status' => 1));
...
case "deactivate":
$id=base64_decode($_REQUEST['id']);
$up=DB::getInstance()->update('expense_category','id',$id,$tmpimg= null,$path= null,array('status' => 0));
...
if((!empty($subcat)) || ($subcat!=""))
{
$up=DB::getInstance()->updatewithoutimage('expense_category','id',$id,array('title' => $subcat, 'updated_by' => $upby,'updated_on' => $date,'status' => 1));
...
<div class="block-header">
	...
	case "edit":
	$id=base64_decode($_REQUEST['id']);
	$del=DB::getInstance()->get('expense_category',array('id','=',$id));
	?>
				<div class="card">
                        <div class="header">
                            <h2>
...
<input type="hidden" name="id" value="<?php echo $id ?>">
								...
								<div class="col-sm-6">
<label for="grid12">Update Expence Category :</label>
...
<div class="card">
                        ...
                        <div class="body">
										...
										<div class="row clearfix">
							<div class="col-sm-6">
<label for="grid12">Enter Expence  Category :</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="grid12"  name="subcat" class="form-control" placeholder="Enter Expence Category">
                                    </div>
                                </div>	
</div>
<div class="col-sm-6">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        <?php 
								             $per_page = 10;  
								            $del=DB::getInstance()->query("select * from expense_category $whereadded_by ORDER by id DESC");
											...
											$del=DB::getInstance()->query("select * from expense_category $whereadded_by  ORDER by id DESC LIMIT $start,$per_page");
											...
											?>
												...
												<td>
												 ...
												 <?php 
															...
															case "1":
															?>
															<a href="expense-category.php?id=<?php echo base64_encode($row->id);?>&mode=deactivate" ><i class="material-icons">done_all</i></a> 
															<?php
															break;
															case "0":
															?>
															<a href="expense-category.php?id=<?php echo base64_encode($row->id);?>&mode=activate" ><i class="material-icons">clear</i></a> 
															<?php
															break;
													...
													<a href="expense-category.php?id=<?php echo base64_encode($row->id);?>&mode=edit" >
												       <i class="material-icons" >create</i>
													</a> 
													
												    <a href="expense-category.php?id=<?php echo base64_encode($row->id);?>&mode=delete" onclick="return confirm('YOU ARE GOING TO DELETE THIS CATEGORY')">
